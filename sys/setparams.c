...
void write_mg_info(FILE *fp, char class) 
{
  ...
  fprintf(fp, "%sconst int nx_default = %d; \n", FINDENT, problem_size);
  fprintf(fp, "%sconst int ny_default = %d; \n", FINDENT, problem_size);
  fprintf(fp, "%sconst int nz_default = %d; \n", FINDENT, problem_size);
  fprintf(fp, "%sconst int nit_default = %d; \n", FINDENT, nit);
  fprintf(fp, "%sconst int lm = %d; \n", FINDENT, lm);
  fprintf(fp, "%sconst int lt_default = %d; \n", FINDENT, lt_default);
  fprintf(fp, "%sconst int debug_default = %d; \n", FINDENT, 0);
  fprintf(fp, "%sconst int ndim1 = %d; \n", FINDENT, ndim1);
  fprintf(fp, "%sconst int ndim2 = %d; \n", FINDENT, ndim2);
  fprintf(fp, "%sconst int ndim3 = %d; \n", FINDENT, ndim3);
}
...
void write_convertdouble_info(int type, FILE *fp)
{
  ...
  case EP:
  case CG:
    fprintf(fp, "%sconst bool convertdouble = ", FINDENT);
#ifdef CONVERTDOUBLE
    fprintf(fp, "true", FINDENT);
#else
    fprintf(fp, "false", FINDENT);
#endif
    fprintf(fp, ";\n");
    break;
  }
